...
value_list = resulted =SurveyResponse.objects.filter().exclude(uid__in=QualityReview.objects.values_list('uid', flat=True).all())[:10]
...
yesterday_date = (datetime.datetime.today() - timedelta(days=1)).strftime('%Y-%m-%d')
...
class SearchV2(TemplateView):
    ...
    def get(self,request):
        ...
        if request.user.username == '112891':
            ...
            # resulted =SurveyResponse.objects.filter(allocated_survey = 1).exclude(uid__in=QualityReview.objects.values_list('uid', flat=True).all())
            ...
            resulted =SurveyResponse.objects.filter(project__in = Project_ids,params__contains=yesterday_date).exclude(uid__in=QualityReview.objects.values_list('uid', flat=True).all())
            ...
            if dict_of_surveyors:
            
                dict_of_surveyors = dict(dict_of_surveyors)
            
            else:
                dict_of_surveyors = None
        ...
        if request.user.username == '112418':
            # resulted =SurveyResponse.objects.filter(allocated_survey = 2).exclude(uid__in=QualityReview.objects.values_list('uid', flat=True).all())[:10]
        ...
        if request.user.username == '113124':
            # resulted =SurveyResponse.objects.filter(allocated_survey = 3).exclude(uid__in=QualityReview.objects.values_list('uid', flat=True).all())[:10]
        ...
        if request.user.username == '110649':
            # resulted =SurveyResponse.objects.filter(allocated_survey = 4).exclude(uid__in=QualityReview.objects.values_list('uid', flat=True).all())[:10]
        ...
        if request.user.username == '109691':
            # resulted =SurveyResponse.objects.filter(allocated_survey = 5).exclude(uid__in=QualityReview.objects.values_list('uid', flat=True).all())[:10]
        ...
        if request.user.username == '111293':
            # resulted =SurveyResponse.objects.filter(allocated_survey = 6).exclude(uid__in=QualityReview.objects.values_list('uid', flat=True).all())[:10]
        ...
        if request.user.username == '107501':
            # resulted =SurveyResponse.objects.filter(allocated_survey = 7).exclude(uid__in=QualityReview.objects.values_list('uid', flat=True).all())[:10]
        ...
        if request.user.username == '112418':
            ...
            # resulted =SurveyResponse.objects.filter(allocated_survey = 8).exclude(uid__in=QualityReview.objects.values_list('uid', flat=True).all())[:10]
        ...
        if request.user.username == '108504':
            # resulted =SurveyResponse.objects.filter(allocated_survey = 9).exclude(uid__in=QualityReview.objects.values_list('uid', flat=True).all())[:10]
        ...
        if request.user.username == '110880':
            # resulted =SurveyResponse.objects.filter(allocated_survey = 10).exclude(uid__in=QualityReview.objects.values_list('uid', flat=True).all())[:10]
        ...
        if request.user.username == '111264':
            # resulted =SurveyResponse.objects.filter(allocated_survey = 11).exclude(uid__in=QualityReview.objects.values_list('uid', flat=True).all())[:10][:10]
        ...
        if request.user.username == '111265':
            # resulted =SurveyResponse.objects.filter(allocated_survey = 12).exclude(uid__in=QualityReview.objects.values_list('uid', flat=True).all())[:10]
        ...
        if request.user.username == '112779':
            # resulted =SurveyResponse.objects.filter(allocated_survey = 13).exclude(uid__in=QualityReview.objects.values_list('uid', flat=True).all())[:10]
        ...
        # 	resulted =SurveyResponse.objects.filter(allocated_survey = 14).exclude(uid__in=QualityReview.objects.values_list('uid', flat=True).all())[:10]
        # 	# resulted = SurveyResponse.objects.filter(~Q(uid__in=QualityReview.objects.values_list('uid', flat=True).all()))&SurveyResponse.objects.filter(allocated_survey = 14)
        ...
        # 	resulted =SurveyResponse.objects.filter(allocated_survey = 15).exclude(uid__in=QualityReview.objects.values_list('uid', flat=True).all())[:10]
        ...
        if request.user.username == '113289':
        ...
        if request.user.username == '101765' or request.user.username == '106480' or request.user.username == '106526':
        ...
        if("filter" not in request.GET.keys() and "uid" in request.GET.keys() and request.GET["uid"]!=""):
            ...
            if(surveyResponse.count()>0):
                ...
                try:
                    ...
                    surveyor_name = (params["surveyor"])[:(params["surveyor"]).find("(")]
                ...
                "sectionDIssueList":sectionDIssueList,
                    ...
                    "submitted_uid_status": uid_submitted
                }
    ...
    def post(self,request):
        ...
        if request.user.username == '111264':
            ...
            # resulted =SurveyResponse.objects.filter(allocated_survey = 11).exclude(uid__in=QualityReview.objects.values_list('uid', flat=True).all())[:10]
            # resulted = SurveyResponse.objects.filter(~Q(uid__in=QualityReview.objects.values_list('uid', flat=True).all()))&SurveyResponse.objects.filter(allocated_survey = 11)
        ...
        if request.user.username == '102405':
            ...
            # resulted =SurveyResponse.objects.filter(allocated_survey = 16).exclude(uid__in=QualityReview.objects.values_list('uid', flat=True).all())[:10]
            # resulted = SurveyResponse.objects.filter(~Q(uid__in=QualityReview.objects.values_list('uid', flat=True).all()))&SurveyResponse.objects.filter(allocated_survey = 16)
    ...
    def exportData(self,data):
        ...
        col = 0
        for data in data:
            #print(type(datetime.datetime.strptime(data.interview_date,'%Y-%m-%d').strftime("%d-%m-%Y")),"<<<<< ")
            ...
            worksheet.write(row, 9, (data.auditor_date).strftime("%d-%m-%Y"))
...
def assign_projects_view(request):
    employees = Employee.objects.filter(employee_id__in = (112418,113124,110649,109691,111293,107501,112418,108504,110880,111264,111265,112779,101765,113289,106480,106526))
