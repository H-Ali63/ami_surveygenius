...
#### qualityreview
from search.models import IssueList

class SuperCheckQualityReview(models.Model):
    ...
    # New Additional
    variation_reason = models.ForeignKey(IssueList, blank=True, null=True, on_delete=models.SET_NULL,related_name='supercheck_issue_list_variation_reason')
    remarksSection_E_variation_1 = models.TextField(max_length=700, blank=True, null=True);
    force_survey_reason = models.ForeignKey(IssueList, blank=True, null=True, on_delete=models.SET_NULL,related_name='supercheck_issue_list_force_survey_reason')
    ...
    question_skipping_incomplete_recordings_reason = models.ForeignKey(IssueList, blank=True, null=True, on_delete=models.SET_NULL,related_name='supercheck_issue_list')
    ...
    question_subject_knowledge_reason = models.ForeignKey(IssueList, blank=True, null=True, on_delete=models.SET_NULL,related_name='supercheck_issue_list_question_subject_knowledge_reason')
    ...
    voice_clarity_reason = models.ForeignKey(IssueList, blank=True, null=True, on_delete=models.SET_NULL,related_name='supercheck_issue_list_voice_clarity_reason')
    ...
    questioning_technique_reason = models.ForeignKey(IssueList, blank=True, null=True, on_delete=models.SET_NULL,related_name='supercheck_issue_list_questioning_technique_reason')
    ...
    convencing_skills_reason = models.ForeignKey(IssueList, blank=True, null=True, on_delete=models.SET_NULL,related_name='supercheck_issue_list_convencing_skills_reason')
    ...
    polite_courteous_reason = models.ForeignKey(IssueList, blank=True, null=True, on_delete=models.SET_NULL,related_name='supercheck_issue_list_polite_courteous_reason')
    ...
    rate_of_speech_reason = models.ForeignKey(IssueList, blank=True, null=True, on_delete=models.SET_NULL,related_name='supercheck_issue_list_rate_of_speech_reason')
    ...
    professionalism_energetic_enthusiastic_reason =models.ForeignKey(IssueList, blank=True, null=True, on_delete=models.SET_NULL,related_name='supercheck_issue_list_professionalism_energetic_enthusiastic_reason')



class A_app_supercheck_QualityReview(models.Model):
    id=models.AutoField(primary_key=True);
    uid=models.IntegerField(blank=False,null=False)
    project_name = models.CharField(max_length=120,blank=True,null=True);
    surveyor_name = models.CharField(max_length=60,blank=True,null=True);
    ...
    survey = models.CharField(max_length=50, blank=True, null=True);
    # New Additional
    variation_reason = models.ForeignKey(IssueList, blank=True, null=True, on_delete=models.SET_NULL,related_name='a_app_supercheck_issue_list_variation_reason')
    remarksSection_E_variation_1 = models.TextField(max_length=700, blank=True, null=True);
    force_survey_reason = models.ForeignKey(IssueList, blank=True, null=True, on_delete=models.SET_NULL,related_name='a_app_supercheck_issue_list_force_survey_reason')
    remarksSection_E_force_survey_1 = models.TextField(max_length=700, blank=True, null=True);
    ...
    remarksSection_A_skipping_incomplete_recordings_2 = models.TextField(max_length=700, blank=True, null=True);
    # question_skipping_incomplete_recordings_reason = models.CharField(max_length=700, blank=True, null=True);
    question_skipping_incomplete_recordings_reason = models.ForeignKey(IssueList, blank=True, null=True, on_delete=models.SET_NULL,related_name='a_app_supercheck_issue_list')

    # Section B new format
    question_subject_knowledge = models.CharField(max_length=60, blank=True, null=True);
    remarksSection_B_question_subject_knowledge_1 = models.TextField(max_length=700, blank=True, null=True);
    remarksSection_B_question_subject_knowledge_2 = models.TextField(max_length=700, blank=True, null=True);
    question_subject_knowledge_reason = models.ForeignKey(IssueList, blank=True, null=True, on_delete=models.SET_NULL,related_name='a_app_supercheck_issue_list_question_subject_knowledge_reason')

    # Section C new format
    voice_clarity = models.CharField(max_length=60, blank=True, null=True);
    remarksSection_C_voice_clarity_1 = models.TextField(max_length=700, blank=True, null=True);
    remarksSection_C_voice_clarity_2 = models.TextField(max_length=700, blank=True, null=True);
    voice_clarity_reason = models.ForeignKey(IssueList, blank=True, null=True, on_delete=models.SET_NULL,related_name='a_app_supercheck_issue_list_voice_clarity_reason')

    questioning_technique = models.CharField(max_length=60, blank=True, null=True);
    remarksSection_C_questioning_technique_1 = models.TextField(max_length=700, blank=True, null=True);
    remarksSection_C_questioning_technique_2 = models.TextField(max_length=700, blank=True, null=True);
    questioning_technique_reason = models.ForeignKey(IssueList, blank=True, null=True, on_delete=models.SET_NULL,related_name='a_app_supercheck_issue_list_questioning_technique_reason')

    convencing_skills = models.CharField(max_length=60, blank=True, null=True);
    remarksSection_C_convencing_skills_1 = models.TextField(max_length=700, blank=True, null=True);
    remarksSection_C_convencing_skills_2 = models.TextField(max_length=700, blank=True, null=True);
    convencing_skills_reason = models.ForeignKey(IssueList, blank=True, null=True, on_delete=models.SET_NULL,related_name='a_app_supercheck_issue_list_convencing_skills_reason')
    ...
    remarksSection_D_polite_courteous_1 = models.TextField(max_length=700, blank=True, null=True);
    remarksSection_D_polite_courteous_2 = models.TextField(max_length=700, blank=True, null=True);
    polite_courteous_reason = models.ForeignKey(IssueList, blank=True, null=True, on_delete=models.SET_NULL,related_name='a_app_supercheck_issue_list_polite_courteous_reason')

    rate_of_speech = models.CharField(max_length=60, blank=True, null=True);
    remarksSection_D_rate_of_speech_1 = models.TextField(max_length=700, blank=True, null=True);
    remarksSection_D_rate_of_speech_2 = models.TextField(max_length=700, blank=True, null=True);
    rate_of_speech_reason = models.ForeignKey(IssueList, blank=True, null=True, on_delete=models.SET_NULL,related_name='a_app_supercheck_issue_list_rate_of_speech_reason')

    professionalism_energetic_enthusiastic = models.CharField(max_length=60, blank=True, null=True);
    remarksSection_D_professionalism_energetic_enthusiastic_1 = models.TextField(max_length=700, blank=True, null=True);
    remarksSection_D_professionalism_energetic_enthusiastic_2 = models.TextField(max_length=700, blank=True, null=True);
    professionalism_energetic_enthusiastic_reason =models.ForeignKey(IssueList, blank=True, null=True, on_delete=models.SET_NULL,related_name='a_app_supercheck_issue_list_professionalism_energetic_enthusiastic_reason')
