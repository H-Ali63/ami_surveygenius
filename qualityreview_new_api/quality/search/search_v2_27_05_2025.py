...
# datetime_today = date.today() - datetime.timedelta(days=1)
...
class SearchV2(TemplateView):
    ...
    def get(self,request):
        ...
        # print("-------",SurveyResponse.objects.filter(project__in = Project_ids,verification_date__gte = datetime_today ).exclude(uid__in=QualityReview.objects.values_list('uid', flat=True).all()))
...
# 
    ...
    def post(self,request):
        ...
        ####### code for highlighting submitted uids ##########
        # submitted_uids = QualityReview.objects.values_list('uid')
                    ...
                    if (len(dates_arr) > 0):
                        ...
                        for dateVal in dates_arr:
                            ...
                            if (project_id_val != 0):
                                ...
                                # print(survey_response_obj.count())
...
class assign_projects(TemplateView):
    ...
    def get(self,request):
        ...
        # print(User.objects.filter(id__in = Employee.objects.filter(designation_id=7).values_list('user_id',flat=True)).values('first_name'))
