...
class A_app_surveyorsAdmin(admin.ModelAdmin):
    list_display = ('a_app_id', 'surveyor_name')
    search_fields = ['emp_id_id__employee_id']

admin.site.register(A_app_surveyors, A_app_surveyorsAdmin)


class PriorityTasksSchedulesIDAdmin(admin.ModelAdmin):
    list_display = ('task_id', 'task_created_by')

admin.site.register(PriorityTasksSchedulesID,PriorityTasksSchedulesIDAdmin)
