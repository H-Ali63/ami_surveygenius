...
def pope(request):
    ...
    query = ("select distinct id1 from quality.search_a_app_data where id1 > 13133")            ### here change id (neeche 2 bar aur)
    ...
    for key in myresult2:
        ...
        sql  = "select * from quality.search_a_app_data where id1 = %s and id1 > 13133"       ### here change id
        ...
        try:
            ...
            sql  = "select Response from quality.search_a_app_data where id1 = %s and question_title like '%FR NAME%' and id1 > 13133"        ### here change id
