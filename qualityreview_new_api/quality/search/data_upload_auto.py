...
try:
    ...
    cursor.execute(f"""SELECT "choices"."respondent_answered_choices"."choice_id", "choices"."respondent_answered_choices"."id" AS "id1", 
            ...
            where "choices"."id" in (321,382,347,325,335,332,344,320,319,342,354,329,400) and "choices"."respondent_answered_choices"."id" >  {max_id}  order by "choices"."respondent_answered_choices".id ASC""")
