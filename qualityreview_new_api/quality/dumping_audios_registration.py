...
# --- CONFIGURATION ---
# Local settings
LOCAL_FOLDER = "C:/venv/qualityreview_new_api/quality/media/registration"
...
REMOTE_FOLDER = "/opt/tomcat/webapps/Registration Audio/"
            ...
            try:
                ...
                sql = """UPDATE quality.search_surveyresponse
                            SET params = REPLACE(
                                params,
                                '/media/registration/',
                                'http://192.168.1.251:8080/Registration Audio/'
                            )
                            WHERE uid = %s AND params LIKE '%/media/registration/%';"""
